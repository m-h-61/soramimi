...
def prd_generate_substrings(text):
    ...
    tagger = MeCab.Tagger('-r /home/mayumi/anaconda3/lib/python3.8/site-packages/unidic/dicdir/mecabrc -d /home/mayumi/anaconda3/lib/python3.8/site-packages/unidic/dicdir')
    # 品詞分解を行う
